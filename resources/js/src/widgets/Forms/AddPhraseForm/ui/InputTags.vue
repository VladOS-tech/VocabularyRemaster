<template>
    <div class="user-input-tags-block">
        <h3>
            Теги:
        </h3>
        <div class="user-tag-search-input-area">
            ...
            <ul class="user-form-tag-selector-list" v-if="showTagSelector && tagSearch.length >= 3">
                <li class="user-tag-selector-list-element button" v-for="tag in unselectedSearchResultTags" :key="tag.id"
