    ...
    <div>
        <div class="add-moderator-block">
            ...
            <div class="input-row">
                ...
                <input type="text" class="input-field input-field-regular" placeholder="Введите пароль модератора"
                    :value="moderatorPassword"
                    @input="setModeratorPassword(($event.target as HTMLTextAreaElement).value)" />
            </div>
...
export default defineComponent({
    ...
    computed: {
        ...mapGetters('addModeratorForm', ['moderatorName', 'moderatorEmail', 'moderatorContact', 'moderatorPassword', 'moderatorContactTelegram', 'moderatorContactEmail',
    ...
    methods: {
        ...mapMutations('addModeratorForm', ['setModeratorName', 'setModeratorEmail', 'setModeratorContact', 'setModeratorPassword', 'setModeratorContactTelegram', 'setModeratorContactEmail',
        ...
        ...mapActions('addModeratorForm', ['addModerator']),
        async checkInput() {
            this.isLoading = true
